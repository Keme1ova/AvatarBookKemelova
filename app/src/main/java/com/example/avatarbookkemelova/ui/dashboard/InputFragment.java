package com.example.avatarbookkemelova.ui.dashboard;
...
import com.example.avatarbookkemelova.MainActivity;
import com.example.avatarbookkemelova.R;
import com.example.avatarbookkemelova.databinding.FragmentInputBinding;
import com.example.avatarbookkemelova.models.Student;
import com.example.avatarbookkemelova.room.AppDataBase;
import com.example.avatarbookkemelova.room.StudentDao;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.btnSave.setOnClickListener(v2 ->{
            ...
            if (nameSurnameStudent.isEmpty() || telStudent.isEmpty()){
                Toast.makeText(requireActivity(), "Заполните поля ИМЯ КОНТАКТА", Toast.LENGTH_SHORT).show();
                isImgSelected = false;
            }else {
                if(isImgSelected){
